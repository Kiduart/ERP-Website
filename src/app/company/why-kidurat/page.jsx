...
export default function WhyKidurat() {
  ...
  const whyKiduratImageElements = [
    ...
    },
    {
      ...
      style: {
        background: "linear-gradient(135deg, rgb(0 201 87), rgb(83 192 183))",
      },
      size: 50,
      angle: 45,
      initial: { y: -80 },
  ...
  return (
    <div className="w-full relative">
      ...
      <Section
        title="Our Impact"
        variant="solid"
        className="bg-grayLight relative"
      >
        <Statistics />
      </Section>
      ...
      <Section
        ...
        variant="gradient"
        className="bg-gradient-to-br from-accentPurple/70 to-emeraldGreen/50"
      >
        <Awards />
      </Section>
      <Section title="Discover Your KIDUART Solution" variant="solid">
        <DiscoverSolutions />
      </Section>
    </div>
  );
