    ...
    >
      ...
      <div className="absolute inset-0 opacity-20">
        <div
          ...
          style={{
            ...
            height: "100px",
            background:
              "linear-gradient(90deg, rgba(0, 182, 239, 0.2), rgba(255, 105, 180, 0.2))",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          >
            ...
            >
              <img
                ...
                loading="lazy"
              />
              <h3 className="text-2xl font-medium text-white font-inter">
                KIDUART
              </h3>
            </motion.div>
            <p className="text-white text-sm text-center md:text-left font-poppins">
              Empowering schools with AI-driven solutions for efficient
              management and enhanced learning outcomes.
            </p>
          ...
          >
            <h4 className="text-lg font-medium mb-4 text-white font-inter">
              Quick Links
            </h4>
            <ul className="space-y-2">
              <motion.li whileHover="hover" variants={linkVariants}>
                <Link
                  href="/"
                  className="text-white text-sm transition font-poppins"
                >
                  Home
                </Link>
              </motion.li>
        ...
        >
          <p className="text-white text-sm font-poppins">
            © {new Date().getFullYear()} KIDUART. All rights reserved.
          </p>
        </motion.div>
      </div>
    </motion.footer>
