            ...
            >
              <div className="relative rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  src={`https://www.youtube.com/embed/RncpQnwMYts?autoplay=${
                    isPlaying ? 1 : 0
                  }&mute=1&loop=1&playlist=RncpQnwMYts`}
                  title="AI in Action"
                  frameBorder="0"
            ...
            <div className="lg:w-1/2 text-right">
              ...
              <div className="backdrop-blur-md bg-white/10 rounded-lg p-8 shadow-lg border border-white/20">
                <p className="text-lg text-gray-800 font-poppins mb-4">
                  Founded in 2018, KIDUART set out to revolutionize education
                  with AI-driven solutions. Our first ERP system in 2020
                  empowered small schools, followed by AI analytics in 2023 that
                  transformed data-driven education.
                </p>
                <p className="text-lg text-gray-800 font-poppins mb-4">
                  By 2025, we’ve impacted over 10 million students across 50+
                  countries, partnering with educators to ensure equity and
                  innovation. Our journey continues with a next-gen platform
                  launching this year.
                </p>
