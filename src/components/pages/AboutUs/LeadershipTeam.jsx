  ...
  const teamMembers = [
    {
      ...
      role: "CEO",
      image:
        "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=100&h=100&fit=crop",
    },
    {
      name: "Bob Carter",
      role: "CTO",
    ...
    },
    {
      ...
      role: "COO",
      image:
        "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=100&h=100&fit=crop",
    },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6 flex flex-col items-center md:items-start">
          <p className="text-lg text-gray-800 font-poppins mb-6 text-center md:text-left">
            Meet the visionaries driving KIDUART’s mission to revolutionize
            education.
          </p>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                <Image
                  ...
                  onError={(e) => {
                    e.target.src =
                      "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?q=80&w=100&h=100&fit=crop";
                  }}
                />
              </motion.div>
            ))}
        ...
        >
          <iframe
            ...
            src={`https://www.youtube.com/embed/YZ7DbgwyD4w?autoplay=${
              isPlaying ? 1 : 0
            }&mute=1&loop=1&playlist=YZ7DbgwyD4w`}
