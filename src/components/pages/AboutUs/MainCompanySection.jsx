...
export default function MainCompanySection() {
  ...
  const videoVariants = {
    ...
    hover: {
      boxShadow: `0 0 30px ${theme.colors.accentCyan}80`,
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-lg text-gray-600 font-poppins mb-6">
              KIDUART is a global leader in education technology, providing
              AI-powered solutions to streamline school management and enhance
              student outcomes. Since 2018, we’ve empowered over 10 million
              students across 50+ countries with innovative tools and a
