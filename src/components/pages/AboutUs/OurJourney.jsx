...
export default function OurJourney() {
  ...
  const milestones = [
    {
      year: "2018",
      title: "KIDUART Founded",
      description:
        "Launched with a mission to revolutionize school management with AI.",
      image:
    ...
    },
    {
      ...
      description:
        "Empowered 500+ schools with our ERP, reducing admin tasks by 30%.",
      image:
              ...
              <Tilt key={index} tiltMaxAngleX={10} tiltMaxAngleY={10}>
                <motion.div
                  ...
                  style={{
                    ...
                    animation:
                      index === activeIndex ? "glitch 1s infinite" : "none",
                  }}
                >
                  ...
                  <div className="p-6">
                    <p className="text-sm font-semibold text-accentCyan">
                      {milestone.year}
                    </p>
