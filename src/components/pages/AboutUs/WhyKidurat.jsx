  ...
  const whyKiduratItems = [
    {
      ...
      title: "Global Reach",
      description:
        "Serving educators in over 50 countries, KIDUART is uniquely positioned to meet your needs and drive educational excellence worldwide.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "With 7+ years of expertise, we support 10+ million students globally, delivering reliable and innovative solutions.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Our solutions prioritize interoperability and security, ensuring a seamless and safe ecosystem for your institution.",
    },
  ];
