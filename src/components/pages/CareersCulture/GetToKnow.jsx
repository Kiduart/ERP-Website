...
export default function GetToKnow() {
  ...
  return (
    <div className="relative py-16">
      <WaveBackground
        gradient={theme.gradients.primaryToCyan}
        height="100px"
        opacity={0.1}
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
        ...
        >
          ...
          >
            Discover what makes KIDUART a great place to work. From our
            mission-driven team to our innovative approach to education, we’re
            committed to creating a workplace where everyone can thrive.
          </p>
        </motion.div>
        <motion.div
