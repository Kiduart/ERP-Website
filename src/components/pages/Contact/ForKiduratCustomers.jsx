  ...
  const supportItems = [
    {
      ...
      description: (
        <>
          Get help with KIDUART products via our support portal or live chat.
          <div className="mt-2 space-y-1">
            <div className="flex items-center">
              <FaPhone className="w-4 h-4 text-primary mr-2" />
              <p className="text-grayDark text-sm font-poppins">
                +1 (123) 456-7894
              </p>
            </div>
            <div className="flex items-center">
    ...
    },
    {
      ...
      description: (
        <>
          Access tutorials, webinars, and certifications to maximize your
          KIDUART experience.
          <div className="mt-2 space-y-1">
            <div className="flex items-center">
              <FaPhone className="w-4 h-4 text-primary mr-2" />
