...
export default function PartnersMediaEmployment() {
  ...
  const partnerItems = [
    {
      title: "Partnerships",
      description: "Collaborate with KIDUART to innovate education solutions.",
      contact: "partners@kiduart.com",
      phone: "+1 (123) 456-7891",
    },
    {
      title: "Media Inquiries",
      description: "Reach out for press releases, interviews, or media kits.",
      contact: "media@kiduart.com",
      phone: "+1 (123) 456-7892",
    },
    {
      title: "Employment Verification",
      description: "Verify employment details for KIDUART staff.",
      contact: "hr@kiduart.com",
          ...
          >
            ...
            {expandedIndex === index && (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <p className="text-grayDark font-poppins mb-2">
                  {item.description}
                </p>
