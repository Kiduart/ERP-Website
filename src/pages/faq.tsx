        ...
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          <SectionReveal>
            ...
            <h1 className="mt-6 text-4xl font-bold text-brand-navy md:text-5xl lg:text-6xl">
              School ERP FAQ for Indian schools
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-xl leading-9 text-brand-navy/[0.72]">
              Straight answers on school management software modules, per-student pricing, student data security,
              and which integrations are actually live. Where something is not built yet, the answer says so.
            </p>
          </SectionReveal>
          ...
          <div className="space-y-14">
            {SITE_FAQ_GROUPS.map((group) => (
              <section key={group.id} id={`faq-${group.id}`} className="scroll-mt-28">
                <InView className="mb-6 flex items-start gap-4 border-b border-brand-navy/[0.08] pb-5">
                  ...
                  <div>
                    <h2 className="motion-kicker text-2xl font-bold text-brand-navy">{group.title}</h2>
