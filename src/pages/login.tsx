  ...
  const roles = [
    {
      ...
      url: "https://portal.kiduart.com/auth/login",
    ...
    },
    {
      ...
      url: "https://portal.kiduart.com/school/auth/login",
    ...
    },
    {
      ...
      url: "https://portal.kiduart.com/parent/auth/login",
    ...
    },
    {
      ...
      url: "https://portal.kiduart.com/student/auth/login",
    ...
    <PageTransition className="pt-20 pb-0">
      <section className="section-space bg-brand-beige/30 border-b border-brand-navy/5 relative overflow-hidden min-h-screen flex flex-col justify-center">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
            ...
            {roles.map((role, idx) => (
              <SectionReveal key={idx} delay={idx * 0.1}>
                <div className="bg-white rounded-2xl p-8 shadow-lg shadow-brand-navy/5 border border-brand-navy/5 hover:shadow-xl hover:border-brand-teal/30 transition-all duration-300 flex flex-col h-full items-start text-left">
                  <div
                    className={`w-16 h-16 rounded-2xl ${role.bg} flex items-center justify-center mb-6`}
                  >
                  ...
                  <p className="text-brand-navy/70 mb-8 flex-grow">
                    {role.description}
                  </p>
          ...
          <SectionReveal
            delay={0.4}
            className="text-center bg-brand-beige/20 p-8 rounded-2xl border border-brand-navy/5"
          >
            ...
            <Link
              href="/help"
              className="text-brand-teal font-bold hover:text-brand-navy transition-colors inline-flex items-center gap-2"
            >
