  ...
  return (
    <>
      <PageSeoHead
        ...
        description={
          panel.summary.length > 155
            ? `${panel.summary.slice(0, 152)}...`
            : panel.summary
        }
      ...
      <PageTransition className="pt-20 pb-0">
        <section className="relative overflow-hidden border-b border-brand-navy/[0.06] bg-white pb-14 pt-12">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                  ...
                  <SignalList
                    items={[
                      ...
                      },
                      {
                        ...
                        title: "Day-one setup",
                        detail:
                          "First hour path so the panel is useful immediately",
                      },
                      {
                        id: "roles",
              ...
              <InView once className="motion-wake space-y-5">
            ...
            >
              <div className="rounded-[2rem] border border-brand-navy/[0.08] bg-white p-6 md:p-8">
                ...
                <p className="mt-3 text-sm leading-6 text-brand-navy/[0.76]">
                  Each item below is a real screen or workflow in the panel, not
                  a category name.
                </p>
              ...
              <div className="rounded-[2rem] border border-brand-navy/[0.08] bg-brand-navy p-6 text-brand-beige md:p-8">
                <h2 className="text-2xl font-bold text-brand-beige">
                  Your first hour here
                </h2>
                <p className="mt-3 text-sm leading-6 text-brand-beige/80">
                  Implementation follows this order, so the panel is useful on
                  day one rather than after a month of configuration.
                </p>
                <ol className="mt-6 space-y-3">
                  {panel.firstHour.map((step, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm leading-6 text-brand-beige/90">
                        {step}
                      </span>
                    </li>
                  ))}
        ...
        >
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              {modules.map((module) => (
                ...
                >
                  ...
                  <span className="mt-2 text-xl font-bold text-brand-navy">
                    {module.moduleName}
                  </span>
            ...
            <SectionReveal
              delay={0.12}
              className="mt-10 rounded-[2rem] border border-brand-navy/[0.08] bg-brand-beige/20 p-6 md:p-8"
            >
              <h3 className="text-xl font-bold text-brand-navy">
                Full areas this panel can reach
              </h3>
...
export const getStaticProps: GetStaticProps<PanelPageProps> = async (
  ...
  return {
    props: {
      ...
      neighbours: {
        previous: previous
          ? { slug: previous.slug, label: previous.label }
          : null,
