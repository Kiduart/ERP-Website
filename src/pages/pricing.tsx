    ...
    <PageTransition className="pt-20 pb-0">
      ...
      <section className="section-space bg-brand-beige/20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <InView
            className="motion-rise mx-auto mb-12 max-w-3xl text-center"
            once
          >
            <div className="section-kicker">
              Straightforward school ERP pricing
            </div>
            ...
            <p className="mt-4 text-lg leading-8 text-brand-navy/[0.72]">
              KIDUART covers the full school operations stack functional areas
              and workflows you switch on as you grow. You pay for active
              students staff, teacher, student and parent logins are included
              and your plan decides which areas are switched on.
            </p>
          </InView>
          ...
          <Stagger
            className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto relative z-20"
            ...
            {pricingPlans.map((plan) => (
              <div
                ...
                className={`relative flex flex-col rounded-3xl bg-white p-8 shadow-2xl ${
                  plan.isPopular
                    ? "border-2 border-brand-teal lg:scale-105"
                    : "border border-brand-navy/10 md:my-8"
                }`}
              >
                {plan.isPopular && (
                ...
                <p className="mt-2 text-sm leading-6 text-brand-navy/[0.7]">
                  {plan.desc}
                </p>
                ...
                <div className="mt-6 border-b border-brand-navy/10 pb-6">
                  ...
                  <div className="mt-1 text-sm text-brand-navy/[0.7]">
                    {plan.price === "Custom"
                      ? "Priced per campus and student count"
                      : `Priced ${plan.unit}`}
                  </div>
                  ...
                  {plan.features.map((feat) => (
                    <li key={feat} className="flex items-start gap-3">
                      <Check
                        ...
                        aria-hidden="true"
                      />
                      <span className="text-sm font-medium leading-6 text-brand-navy/[0.82]">
                        {feat}
                      </span>
                    </li>
                  ))}
      ...
      <section className="section-space relative overflow-hidden border-y border-brand-navy/5 bg-white">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <InView className="motion-rise mx-auto max-w-3xl text-center" once>
            ...
            <p className="mt-4 text-lg leading-8 text-brand-navy/[0.74]">
              Core carries the {coreAreaCount} areas a school cannot run a day
              without. Complete adds the rest. Group applies Complete across
              every campus under one organisation. Open any area to read its
              full module list before you decide.
            </p>
          </InView>

          <div className="mt-12 overflow-hidden rounded-[2rem] border border-brand-navy/10 shadow-xl shadow-brand-navy/5">
            <table className="w-full border-collapse text-left">
              ...
              <thead>
                <tr className="bg-brand-navy text-brand-beige">
                  <th
                    scope="col"
                    className="px-5 py-4 text-sm font-bold uppercase tracking-[0.14em]"
                  >
                    Module area
                  </th>
                  <th
                    scope="col"
                    className="px-3 py-4 text-center text-sm font-bold uppercase tracking-[0.14em]"
                  >
                    Core
                  </th>
                  <th
              ...
              <Stagger as="tbody" itemClassName="motion-row">
                  ...
                  >
                    ...
                    <td className="px-3 py-4 text-center">
                      {area.inCore ? (
                        <>
                          <Check
                            className="mx-auto h-5 w-5 text-brand-teal"
                            aria-hidden="true"
                          />
                        ...
                        <>
                          <Minus
                            className="mx-auto h-5 w-5 text-brand-navy/30"
                            aria-hidden="true"
                          />
          ...
          <div className="mt-8">
            <p className="max-w-3xl text-base leading-8 text-brand-navy/[0.74]">
              When an area is included in your plan, it arrives complete the
              everyday actions your staff repeat and the configuration around
              them, like grading rules, fee templates, permissions and report
              formats. Nothing inside an area you already have is held back as a
              paid unlock.
            </p>
          </div>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          <InView className="motion-rise" once>
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-brand-navy/[0.74]">
              These areas depend heavily on how your campus runs, so we scope
              them with you instead of guessing.
            </p>
          </InView>
          <div className="mt-8 grid gap-6 sm:grid-cols-3">
            {[
              ...
              >
                ...
                <p className="mt-2 text-sm leading-6 text-brand-navy/[0.72]">
                  {addon.note}
                </p>
                <Link
      ...
      <section className="section-space bg-white relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <InView className="motion-rise mb-12 text-center" once>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {pricingFaqs.map((faq) => (
              ...
              >
                ...
                <p className="ml-7 text-sm leading-7 text-brand-navy/[0.74]">
                  {faq.a}
                </p>
              </div>
            ))}
