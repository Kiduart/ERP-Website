          ...
          <div className="grid gap-10 lg:grid-cols-[1.35fr_1fr] lg:items-start">
            <SectionReveal>
              ...
              <h2 className="mt-4 text-3xl font-bold text-brand-navy md:text-4xl">
                Schools hold the most sensitive data there is, and almost none
                of it is optional
              </h2>
              <p className="mt-5 text-lg leading-8 text-brand-navy/[0.74]">
                A school system holds records of minors, guardian contact
                details, family financial history and academic performance. None
                of it can be deleted to reduce risk a transfer certificate needs
                the history, and a fee dispute needs the ledger. So the only
                workable answer is to control who can reach what, prove what
                happened, and keep one school's data out of another's reach.
              </p>
              <p className="mt-4 text-lg leading-8 text-brand-navy/[0.74]">
                Security in KIDUART is not a paid add-on. It is a functional
                area like any other, with its own workflows and controls, and it
                applies to every panel from the system admin console down to a
                parent checking one child's attendance.
              </p>
              <Link
            ...
            <SectionReveal
              delay={0.15}
              className="rounded-[2rem] border border-brand-navy/[0.1] bg-white p-5 shadow-sm sm:p-6"
            >
                ...
                {[
                  {
                    ...
                    detail: "Login to audit  stacked, not bolted on",
                  },
                  {
                    value: "Role-based",
                    label: "Access control",
                    detail: "Teachers, finance and parents see only their desk",
                  },
                  {
                    value: "Per school",
                    label: "Data isolation",
                    detail: "Each campus stays in its own tenant",
                  },
                  {
                    value: "Audited",
                    label: "Sensitive actions",
                    detail: "Marks, fees and permissions leave a trail",
                  },
                ].map((item) => (
                  <li
                    key={item.label}
              ...
              <div className="mt-4 rounded-2xl border border-brand-navy/[0.1] bg-brand-beige/25 p-5">
                ...
                <p className="mt-3 text-sm leading-7 text-brand-navy/[0.78]">
                  Verified logins with optional authenticator-app MFA,
                  permissions decided by role, each school in its own tenant
                  database, sessions you can revoke, optional IP and location
                  fencing, and an audit trail for sensitive actions.
                </p>
              </div>
            </SectionReveal>
          </div>
        ...
        <div className="page-shell relative z-10">
          <SectionReveal className="mx-auto mb-10 max-w-3xl text-center">
            ...
            <h2 className="mt-5 text-3xl font-bold text-brand-navy md:text-4xl">
              What happens when a password leaks, a teacher leaves, or a mark
              changes quietly?
            </h2>
            <p className="mt-4 text-lg leading-8 text-brand-navy/[0.74]">
              Work through every scenario. Each answer points to the exact
              defence layer and the controls that exist in the product today.
            </p>
          </SectionReveal>
      ...
      <section className="section-space relative overflow-hidden bg-brand-beige/25">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <InView once className="motion-rise mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-brand-navy/[0.74]">
              Read them the way a request travels: someone signs in, their role
              is checked, their school is resolved, their session is tracked,
              the network they came from is evaluated, and whatever they change
      ...
      <section className="section-space relative overflow-hidden border-y border-brand-navy/5 bg-white">
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <SectionReveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-brand-navy/[0.74]">
              These are the same principles written into our privacy policy
              stated here in plain language so your IT reviewer does not have to
              read legal text to understand them.
            </p>
          </SectionReveal>

          <Stagger
            className="mt-12 grid gap-6 md:grid-cols-2"
            itemClassName="motion-stack relative rounded-[1.75rem] border border-brand-navy/[0.1] bg-brand-beige/20 p-7"
          >
            {DATA_HANDLING_PRINCIPLES.map((principle, idx) => (
              <div key={principle.title}>
                ...
                <h3 className="max-w-[85%] text-xl font-bold text-brand-navy">
                  {principle.title}
                </h3>
                <p className="mt-3 text-sm leading-7 text-brand-navy/[0.78]">
                  {principle.detail}
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <SectionReveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-brand-beige/[0.82]">
              Most vendor security pages read the same. This section says what
              is not true yet, because that is the part your IT reviewer
              actually needs.
            </p>
          </SectionReveal>
            ...
            {SECURITY_HONESTY.map((item, idx) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-7 text-brand-beige/[0.82]">
                    {item.detail}
                  </p>
                </div>
              </SectionReveal>
